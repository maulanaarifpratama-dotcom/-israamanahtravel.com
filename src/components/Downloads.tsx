...
export default function Downloads() {
  return (
    <section id="itinerary" className="bg-cream py-20 px-5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12" data-animate>
          ...
          <p className="text-ink-muted mt-3 text-base font-body max-w-xl mx-auto">
          ...
          {pdfs.map((pdf) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div
                  className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 text-goldink"
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-auto">
                {/* px-4 + nowrap: the inherited px-7 made "Download PDF" wrap
                    and spill out of the pill in this narrow two-up column. */}
                <a
                  href={pdf.href}
                  download
                  className="btn-gold flex-1 py-3 px-4 text-sm gap-2 whitespace-nowrap"
                ...
                <a
                  ...
                  className="btn-wa flex-1 py-3 px-4 text-sm gap-2 whitespace-nowrap"
                >
                  <WhatsAppIcon />
                  Tanya Maya
                </a>
